...
class KecamatanTableSeeder extends Seeder
{
    ...
    {
        $csvFile = database_path('seeders/csv/kecamatan.csv');
        ...
        $this->command->info("Seeder kecamatan selesai. Total data diproses: " . count($insertData));
    }
}
